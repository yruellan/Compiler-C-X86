...
void Stmt::print(string indent){
    cout << indent << "Stmt" << endl;
}

void Sscope::print(string indent){
    cout << indent << "Sscope" << endl;
    for(auto v : body){
        v->print(indent + "  ");
    }
}
...
void Sreturn::print(string indent){
    cout << indent << "Sreturn" << endl;
    value->print(indent + "  ");
}

void Sfor::print(string indent){
    cout << indent << "Sfor" << endl;
    init->print(indent + "  ");
...
void Swhile::print(string indent){
    cout << indent << "Swhile" << endl;
    condition->print(indent + "  ");
    body->print(indent + "  ");
}

void SvarDef::print(string indent){
    cout << indent << "SvarDef: " << type << " " << name << endl;
    if(value != nullptr){
        value->print(indent + "  ");
    }
}
...
void Sexpr::print(string indent){
    cout << indent << "Sexpr" << endl;
    value->print(indent + "  ");
}

void Sif::print(string indent){
    cout << indent << "Sif" << endl;
    condition->print(indent + "  ");
    body->print(indent + "  ");
}

void SifElse::print(string indent){
    cout << indent << "SifElse" << endl;
    condition->print(indent + "  ");
